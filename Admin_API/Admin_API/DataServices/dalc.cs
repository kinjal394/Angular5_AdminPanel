...
namespace Admin_API.DataServices
{
    public class dalc
    {
        ...
        public dalc()
        {
            conn.ConnectionString = @"Data Source=DESKTOP-BRR56Q3\\SQLEXPRESS1;Initial Catalog=AdminAng5DB;Persist Security Info=True;User ID=sa;Password=k8469882853";
